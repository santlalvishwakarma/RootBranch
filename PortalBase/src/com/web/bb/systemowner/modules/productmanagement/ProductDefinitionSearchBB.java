...
public class ProductDefinitionSearchBB extends BackingBean {
	...
	public void retrieveData() {
		...
		// try {
		// productHierarchyList = new
		// ProductDefinitionBF().getSuggestedHierarchies(new
		// ProductHierarchyDVO());
	...
	public List<ProductCategoryDVO> getSuggestedCategories(String query) {

		List<ProductCategoryDVO> productCategoryList = new ArrayList<ProductCategoryDVO>();
		if (query != null) {
			query = query.toUpperCase();

			for (ProductCategoryDVO productCategoryRecord : productCategoriesForAutoSuggest) {
