...
public class SizeMasterBB extends BackingBean {
		...
		if (tabId.equals("searchListSku")) {
			if (!FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
				...
				FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
						.put(CommonConstant.RE_INITIALIZE_OPR, new SizeOpr());
			}
		} else if (tabId.equals("addeditSize")) {
			if (!FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
					.containsKey(CommonConstant.ACTIVE_TAB_OPR)) {
				FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
						.put(CommonConstant.ACTIVE_TAB_OPR, new SizeOpr());
			}
		}
	}
