...
public class ColorMasterBB extends BackingBean {
	...
	public void tabChanged(TabChangeEvent event) {
		...
		myLog.debug(" In ColorMasterBB : tabChanged : tab id : " + tabId);

		if (tabId.equals("searchListColor")) {
			if (!FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
				...
				FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
						.put(CommonConstant.RE_INITIALIZE_OPR, new ColorOpr());
			}
		} else if (tabId.equals("addeditColor")) {
			if (!FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
					.containsKey(CommonConstant.ACTIVE_TAB_OPR)) {
				FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
						.put(CommonConstant.ACTIVE_TAB_OPR, new ColorOpr());
			}
		}
	}
