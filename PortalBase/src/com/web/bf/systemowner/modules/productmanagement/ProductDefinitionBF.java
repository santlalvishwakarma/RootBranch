...
public class ProductDefinitionBF extends BusinessFacade {
	...
	public ArrayList<Object> getSuggestedHierarchies(ProductHierarchyDVO productHierarchyDVO)
			throws FrameworkException, BusinessException {
		return new ProductSF().getSuggestedHierarchies(productHierarchyDVO);
	}
