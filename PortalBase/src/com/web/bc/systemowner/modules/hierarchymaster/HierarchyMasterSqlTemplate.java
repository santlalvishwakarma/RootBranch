...
public interface HierarchyMasterSqlTemplate extends SqlTemplate {
	...
	public static final String SEARCH_PRODUCTS_HIERARCHY = "CALL sp_product_search_hierarchies(?,?,?, @p_error_code, @p_error_message);";

	public static final String GET_PRODUCTS_HIERARCHY_LEVEL = "SELECT phcm.product_hierarchy_category_mapping_id, phcm.product_hierarchy_id, phcm.level,"
	...
	public static final String SAVE_PRODUCTS_HIERARCHY = "CALL sp_product_save_hierarchies(?,?,?,?,?,?,?, @p_last_inserted_id, @p_error_code, @p_error_message);";

	public static final String GET_SUGGESTED_HIERARCHY = "SELECT hierarchy_id, hierarchy_code, hierarchy_name, hierarchy_description, "
			+ " hierarchy_sequence, is_active, created_by, created_date, modified_by, modified_date FROM hierarchy_master";

	public static final String GET_SUGGESTED_PRODUCTS_HIERARCHY_BASED_ON_CATEGORY = "SELECT DISTINCT phmm.product_hierarchy_id ,"
	...
	public static final String SAVE_EDIT_HIERARCHY = " CALL sp_save_edit_hierarchy(?, ?, ?, ?, ?, ?, ?, @p_error_code, @p_error_message); ";
