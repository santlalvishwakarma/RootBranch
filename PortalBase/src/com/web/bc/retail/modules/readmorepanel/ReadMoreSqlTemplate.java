...
public interface ReadMoreSqlTemplate extends SqlTemplate {
	...
	public static final String GET_PRODUCT_HEADER = " SELECT ph.product_id, ph.product_code, ph.product_name, ph.status_code, "
			+ " ph.default_hierarchy_id, fn_get_hierarchy_name_based_on_id(ph.default_hierarchy_id) hierarchy_name, "
			+ " fn_get_hierarchy_code_based_on_id(ph.default_hierarchy_id) hierarchy_code, "
			...
			+ " AND psh.product_id = ? AND psh.product_sku_id = ?; ";

	public static final String GET_PRODUCT_ALTERNATIVE_IMAGES = " SELECT psim.product_sku_image_mapping_id, psim.product_sku_id, "
			+ " psim.image_type, psim.thumbnail_image_url, psim.zoom_image_url, psim.sequence_no "
	...
	public static final String GET_CATEGORIES_FOR_PRODUCT = " SELECT phcm.product_hierarchy_category_mapping_id, "
			+ " phcm.hierarchy_category_mapping_id, phcm.hierarchy_id, fn_get_hierarchy_name_based_on_id(phcm.hierarchy_id) hierarchy_name, "
